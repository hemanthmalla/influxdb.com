...
- 64-bit system install instructions
		...
		wget https://s3.amazonaws.com/get.influxdb.org/telegraf/telegraf_0.2.1_amd64.deb
		sudo dpkg -i telegraf_0.2.1_amd64.deb
...
- 64-bit system install instructions
		...
		wget https://s3.amazonaws.com/get.influxdb.org/telegraf/telegraf-0.2.1-1.x86_64.rpm
		sudo yum localinstall telegraf-0.2.1-1.x86_64.rpm
...
- 64-bit system download & decompress instructions
		...
		wget https://s3.amazonaws.com/get.influxdb.org/telegraf/telegraf_linux_amd64_0.2.1.tar.gz
		tar xvfz telegraf_linux_amd64_0.2.1.tar.gz
